...
from models.translator.model import ConceptTranslator
...
class ClipCap(nn.Module):
    ...
    def text_decode(
        self, clip_features, entry_length=30, temperature=1, batch_size=128
    ):
        return self.translator.decode(
            clip_features, entry_length, temperature, batch_size
        )
