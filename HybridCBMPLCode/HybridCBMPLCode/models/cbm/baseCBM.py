...
import torchmetrics
from loss.regularization import DiscriminabilityLoss, OrthogonalityLoss
...
class CBM(L.LightningModule):
    ...
    def on_test_epoch_end(self):
        ...
        self.log("test_img_concept_purity_static", self.all_img_concept_purity["static"], on_step=False, on_epoch=True)
        self.log("test_img_concept_purity_dynamic", self.all_img_concept_purity["dynamic"], on_step=False, on_epoch=True)
        self.log("test_img_concept_coverage_static", self.all_img_concept_coverage["static"], on_step=False, on_epoch=True)
        self.log("test_img_concept_coverage_dynamic", self.all_img_concept_coverage["dynamic"], on_step=False, on_epoch=True)
