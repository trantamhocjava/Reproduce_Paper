...
import utils
from concept_dataset import explicid_busi_dict, explicid_idrid_dict, explicid_isic_dict
from dataset.busi_dataset import BUSIDataset
from dataset.idrid_dataset import IDRIDDataset
...
from ExplicdCode.Explicd.dataset.dataset import SkinDatasetV1

DATASET_DICT = {"isic2018": SkinDatasetV1, "IDRID": IDRIDDataset, "BUSI": BUSIDataset}

NUM_CLASS_DICT = {"isic2018": 7, "IDRID": 5, "BUSI": 3}

CLS_WEIGHT_DICT = {"isic2018": [1, 0.5, 1.2, 1.3, 1, 2, 2], "IDRID": None, "BUSI": None}
...
def build_model(config):
    model = ExpLICD(
        concept_list=CONCEPT_DATASET_DICT[config.dataset],
